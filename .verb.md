...
- `language` **{String}**: A [BCP 47 language tag][tag], or an [Intl.Locale][locale] instance.
...
[tag]: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/Segmenter/Segmenter#parameters
[locale]: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/Locale
